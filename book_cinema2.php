   ...
   if (!isset($_SESSION['name']) || empty($_SESSION['name'])){
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
      //display available seats  
        $sqlcheck = "SELECT * FROM cinema_available WHERE time_slot = '".$_POST['sched']."' AND cinema='2'";
        ...
        $sql1 = "SELECT * FROM cinema_available WHERE cinema ='2' and time_slot = '$time_slot'";
        ...
        $sqladd = "UPDATE cinema_available SET number_of_seats = '$limit' WHERE cinema ='2' and time_slot = '$time_slot'";
 ...
 <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
        ...
        <center>   
             <div class="uk-card uk-card-secondary ">
                    <h1 class="uk-card-title">Cinema 2 Reservation</h1>
                </center>
            </div>
              ...
              <div>
                 <div class="uk-card-body">
					 ...
					 <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
							...
							<span class="help-block"><?php echo $ticket_err;?></span><br>
                             <div id="results"></div>
                            <?php 
                                $numSeats = array();
                                $sqlg = "SELECT * FROM cinema_available WHERE cinema ='2'";
