<?php 
   ...
   if (!isset($_SESSION['name']) || empty($_SESSION['name'])){
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sqlcheck = "SELECT * FROM cinema_available WHERE time_slot = '".$_POST['sched']."' AND cinema='1'";
        ...
        if ($dataCheck['number_of_seats'] < 1) {
            ...
            $sql1 = "SELECT * FROM cinema_available WHERE cinema ='1' and time_slot = '$time_slot'";
            ...
            $sqladd = "UPDATE cinema_available SET number_of_seats = '$limit' WHERE cinema ='1' and time_slot = '$time_slot'";
 ...
 <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
            <nav class="uk-navbar-container" uk-navbar style="position: relative; z-index: 980;background-color:black; color:white; height:50px">
                ...
                <div class="uk-navbar-right">
                 ...
                 <center>   
             <div class="uk-card uk-card-secondary " style=" margin-bottom:0px; color:white;" >
                    <h1 class="uk-card-title">Cinema 1 Reservation</h1>
                </center>
            </div>
