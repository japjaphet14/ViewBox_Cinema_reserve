<?php 
  ...
  exit;
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sqlcheck = "SELECT * FROM cinema_available WHERE time_slot = '".$_POST['sched']."' AND cinema='3'";
        ...
        $sql1 = "SELECT * FROM cinema_available WHERE cinema ='3' and time_slot = '$time_slot'";
        ...
        $sqladd = "UPDATE cinema_available SET number_of_seats = '$limit' WHERE cinema ='3' and time_slot = '$time_slot'";
 ...
 <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
        ...
        <center>   
             <div class="uk-card uk-card-secondary ">
                    <h1 class="uk-card-title">Cinema 3 Reservation</h1>
                </center>
            </div>
    <div class="uk-card uk-card-secondary uk-grid-collapse uk-child-width-1-2@s uk-margin" style=" margin-left:50px; margin-right:50px; margin-top:0px; margin-bottom:0px"uk-grid>
              ...
              <div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <?php 
                                $numSeats = array();
                                $sqlg = "SELECT * FROM cinema_available WHERE cinema ='3'";
